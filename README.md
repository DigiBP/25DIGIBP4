...
**Internal**
- Customer Service: handles the incoming PO including the check of availability of ordered goods and informs other process participants of the outcome
...
![Webhook Return Process](Pictures/Make_Voiceflow_Webhook_Reclamation_Process.png)
